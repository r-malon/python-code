...
class MeuGtk(Gtk.Window):
	...
	def atualizar(self, widget):
		"""
		criar uma string com o conteudo da entry no caso self.texto, 
		depois verificar qual operação esta sendo feita, 
		posteriormente fazer um split. ex: string.split("operação") em uma lista
		"""
		if widget.get_label() == "=":
